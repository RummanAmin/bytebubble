  ...
  <div class="band main">
    <section class="layout">
      ...
      <article>
        <h3>Faz Ahmed</h3>
        <h5>Web Developer</h5>
        <p>Faz has worked in IT for over 15 years, been programming for over 20 years and has worked for some of the world's largest IT providers. He’s also got a substantial collection of very old books.</p>
      </article>
      <!-- <article>
        <h3>Katie Harper</h3>
        <h5>Designer</h5>
        <p>Sophia left the world of Law to pursue her love of pixels. She quickly developed a passion for design which has never left her and now acts as our master of all things Adobe.</p>
      </article> -->
      <article>
